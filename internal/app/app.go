...
import (
	...
	"github.com/puppypatch/puppypatch/internal/filetracker"
	"github.com/puppypatch/puppypatch/internal/format"
	"github.com/puppypatch/puppypatch/internal/history"
	"github.com/puppypatch/puppypatch/internal/log"
	...
	"github.com/puppypatch/puppypatch/internal/update"
...
type App struct {
	...
	// subscribers (notably `puppypatch run` in client/server mode) can
...
// for `puppypatch run`. A lossy fan-in here can drop the only terminal
