...
puppypatch update-providers

# Update Catwalk providers from a custom URL
puppypatch update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
puppypatch update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
puppypatch update-providers embedded

# Update Hyper provider information
puppypatch update-providers --source=hyper

# Update Hyper from a custom URL
puppypatch update-providers --source=hyper https://hyper.example.com
`,
