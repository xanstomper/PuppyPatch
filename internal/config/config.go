...
import (
	...
	"github.com/puppypatch/puppypatch/internal/csync"
	"github.com/puppypatch/puppypatch/internal/oauth"
	"github.com/puppypatch/puppypatch/internal/oauth/copilot"
	"github.com/invopop/jsonschema"
)

const (
	appName              = "puppypatch"
	defaultDataDirectory = ".puppypatch"
...
type ProviderConfig struct {
	...
	// When Models is empty and this is nil or true, PuppyPatch auto-discovers
...
type Attribution struct {
	...
	GeneratedWith bool         `json:"generated_with,omitempty" jsonschema:"description=Add Generated with PuppyPatch line to commit messages and issues and PRs,default=true"`
}
...
type Options struct {
	...
	GlobalContextPaths   []string    `json:"global_context_paths,omitempty" jsonschema:"description=Paths to files containing global context information for the AI,default=~/.config/puppypatch/CRUSH.md,default=~/.config/AGENTS.md"`
	SkillsPaths          []string    `json:"skills_paths,omitempty" jsonschema:"description=Paths to directories containing Agent Skills (folders with SKILL.md files),example=~/.config/puppypatch/skills,example=./skills"`
	TUI                  *TUIOptions `json:"tui,omitempty" jsonschema:"description=Terminal user interface options"`
	Debug                bool        `json:"debug,omitempty" jsonschema:"description=Enable debug logging,default=false"`
	DebugLSP             bool        `json:"debug_lsp,omitempty" jsonschema:"description=Enable debug logging for LSP servers,default=false"`
	DisableAutoSummarize bool        `json:"disable_auto_summarize,omitempty" jsonschema:"description=Disable automatic conversation summarization,default=false"`
	// DataDirectory is where PuppyPatch keeps per-project state such as
	// the SQLite database and workspace overrides. Relative paths are
	// resolved against the working directory; absolute paths are used
	// verbatim. After defaulting the stored value is always absolute.
	DataDirectory             string       `json:"data_directory,omitempty" jsonschema:"description=Directory for storing application data. Relative paths are resolved against the working directory; absolute paths are used as-is.,default=.puppypatch,example=.puppypatch"`
	...
	DisabledSkills            []string     `json:"disabled_skills,omitempty" jsonschema:"description=List of skill names to disable and hide from the agent,example=puppypatch-config"`
}
...
// Config holds the configuration for puppypatch.
type Config struct {
