...
import (
	...
	"github.com/puppypatch/puppypatch/internal/env"
	"github.com/puppypatch/puppypatch/internal/filepathext"
...
// fallback keeps PuppyPatch from silently adopting state files placed above
// the current project.
...
func GlobalSkillsDirs() []string {
	...
	// On Windows, also load from app data on top of `$HOME/.config/puppypatch`.
...
// ProjectSkillsDir returns the default project directories for which PuppyPatch
