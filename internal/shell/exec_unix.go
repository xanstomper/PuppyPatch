...
// fully detached from PuppyPatch's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to PuppyPatch's process
// group.
...
// from PuppyPatch's session and controlling terminal.
//
