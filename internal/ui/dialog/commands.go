...
func (c *Commands) defaultCommands() []*CommandItem {
	...
	// PuppyPatch red team commands
	commands = append(commands,
		NewCommandItem(c.com.Styles, "scan", "Scan Target", "", ActionRunScan{}),
		NewCommandItem(c.com.Styles, "audit", "Code Audit", "", ActionRunAudit{}),
		NewCommandItem(c.com.Styles, "pentest", "Pentest Session", "", ActionRunPentest{}),
		NewCommandItem(c.com.Styles, "garak", "Garak LLM Scan", "", ActionRunGarak{}),
		NewCommandItem(c.com.Styles, "jailbreak", "Jailbreak Techniques", "", ActionListJailbreaks{}),
		NewCommandItem(c.com.Styles, "tools", "All Tools", "", ActionListTools{}),
		NewCommandItem(c.com.Styles, "help", "Red Team Help", "", ActionShowHelp{}),
	)
