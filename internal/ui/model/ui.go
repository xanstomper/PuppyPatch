...
import (
	...
	agenttools "github.com/puppypatch/puppypatch/internal/agent/tools"
	"github.com/puppypatch/puppypatch/internal/agent/tools/mcp"
	"github.com/puppypatch/puppypatch/internal/app"
	"github.com/puppypatch/puppypatch/internal/clipboard"
	"github.com/puppypatch/puppypatch/internal/commands"
	...
	"github.com/puppypatch/puppypatch/internal/home"
	...
	"github.com/puppypatch/puppypatch/internal/stringext"
	"github.com/puppypatch/puppypatch/internal/ui/anim"
	"github.com/puppypatch/puppypatch/internal/ui/attachments"
	"github.com/puppypatch/puppypatch/internal/ui/chat"
	"github.com/puppypatch/puppypatch/internal/ui/common"
	"github.com/puppypatch/puppypatch/internal/ui/completions"
	"github.com/puppypatch/puppypatch/internal/ui/dialog"
	fimage "github.com/puppypatch/puppypatch/internal/ui/image"
	"github.com/puppypatch/puppypatch/internal/ui/logo"
	"github.com/puppypatch/puppypatch/internal/ui/notification"
	"github.com/puppypatch/puppypatch/internal/ui/styles"
	"github.com/puppypatch/puppypatch/internal/ui/util"
...
func (m *UI) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		text := fmt.Sprintf("PuppyPatch update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			text = fmt.Sprintf("This is a development version of PuppyPatch. The latest version is v%s.", msg.LatestVersion)
		}
		ttl := 10 * time.Second
...
func (m *UI) View() tea.View {
	...
	v.WindowTitle = "puppypatch " + home.Short(m.com.Workspace.WorkingDir())
...
// renderLogo renders the PuppyPatch logo with the given styles and dimensions.
