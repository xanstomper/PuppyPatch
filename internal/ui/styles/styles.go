...
import (
	...
	"github.com/puppypatch/puppypatch/internal/ui/diffview"
)
...
type Styles struct {
	...
	// PuppyPatch's background. Defining them here keeps output readable and
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "PuppyPatch" wordmark gradient start
		SmallGradToColor   color.Color    // Small "PuppyPatch" wordmark gradient end
	}
